...
const int PERMUTED_CHOICE_1[56] = {
	 57,49,41,33,25,17,9,
		...
		14,6,61,53,45,37,29,
		21,13,5,28,20,12,4
>>>>>>> f4a6b3d3a7d2a55b5a183f60f5624071539a0a97
};
...
<<<<<<< HEAD
	...
	//try {
	//	string cipherText = DESAlgorithm(plainText, isEncrypt);
	//	cout << "CipherText is: " << cipherText << endl;
	//	cout << "CipherText decripyed is: " << DESAlgorithm(cipherText, false) << endl;
	//}
	//catch (const char* errorMessage) {
	//	cout << errorMessage << endl;
	//}
...
string DESEncrypt(string plainText) {
	...
	string PC1Text = initialPermutation(plainTextInBinary);
...
=======
		...
		switch (i+1) {
		case 1: 
			resultFromSboxes += decimalToBinary(S1[row][column]);
			break;
		case 2:
			resultFromSboxes += decimalToBinary(S2[row][column]);
			break;
		case 3:
			resultFromSboxes += decimalToBinary(S3[row][column]);
			break;
		case 4:
			resultFromSboxes += decimalToBinary(S4[row][column]);
			break;
		case 5:
			resultFromSboxes += decimalToBinary(S5[row][column]);
			break;
		case 6:
			resultFromSboxes += decimalToBinary(S6[row][column]);
			break;
		case 7:
			resultFromSboxes += decimalToBinary(S7[row][column]);
			break;
		case 8:
			resultFromSboxes += decimalToBinary(S8[row][column]);
>>>>>>> f4a6b3d3a7d2a55b5a183f60f5624071539a0a97
			break;
		};
	};
